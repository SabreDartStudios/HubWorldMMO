...
#include "HWAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FHWAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class OWSHUBWORLDMMO_API UHWAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, Category = Ability, meta = (TitleProperty = "AbilityTag"))
		TArray<FHWAbilityTagRelationship> AbilityTagRelationships;
